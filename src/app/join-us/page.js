    ...
    const handleOtpVerify = async (e) => {
      ...
      try {
        ...
        const apiUrl = buySell === "buy" 
          ? "/api/auth/verifyotpbuyer" : `/api/auth/verifyotp`; // Seller API
      ...
      {otpSent ? (
        <form onSubmit={handleOtpVerify}>
          <input type="text" value={otp} onChange={(e) => setOtp(e.target.value)} required
            className="w-full p-3 mb-4 rounded bg-gray-700 text-white" placeholder="Enter OTP" />
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" value={productname} onChange={(e) => setProductname(e.target.value)} required
            className="w-full p-3 mb-3 rounded bg-gray-700 text-white" placeholder="Product Name" />
...
<div className="flex gap-3 mb-3 ">
  <div className="w-1/3">
    <Select
      ...
      className=" text-white rounded-md  py-1"
          ...
          {buySell === "sell" && (
            <>
              <input type="text" value={fullname} onChange={(e) => setFullname(e.target.value)} required
                className="w-full p-3 mb-3 rounded bg-gray-700 text-white" placeholder="Full Name" />
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required
                className="w-full p-3 mb-3 rounded bg-gray-700 text-white" placeholder="Email" />
              {/* <input type="text" value={companyName} onChange={(e) => setCompanyName(e.target.value)} required
                className="w-full p-3 mb-3 rounded bg-gray-700 text-white" placeholder="Company Name" />
              <input type="text" value={pincode} onChange={(e) => setPincode(e.target.value)} required
                className="w-full p-3 mb-3 rounded bg-gray-700 text-white" placeholder="Pincode" /> */}
            </>
          )}
