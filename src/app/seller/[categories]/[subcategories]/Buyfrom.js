...
const Buyfrom = ({ product, sellerId }) => {
  ...
  return (
    <>
      <button
        onClick={toggleModal}
        className="bg-blue-600 mt-2 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md shadow-md transition-all duration-300 flex items-center justify-center gap-2"
      >
