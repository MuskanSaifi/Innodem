...
const Buyfrom = ({ product, sellerId }) => {
  ...
  return (
    <>
      <button onClick={toggleModal} className="mt-2 bg-blue-600 hover:bg-blue-700 text-sm text-white font-semibold py-2 px-3 rounded-xl shadow-md transition-all duration-300 flex items-center justify-center gap-2">
