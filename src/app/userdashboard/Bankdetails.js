...
const BankDetails = () => {
  ...
  useEffect(() => {
    const fetchBankDetails = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:3000/api/userprofile/profile/bankdetails", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch("http://localhost:3000/api/userprofile/profile/bankdetails", formData, {
        headers: {
