...
const PDFClientSideWrapper = ({ userAgreement, handleDownloadComplete }) => {
    ...
    return (
        // The outer div now explicitly defines a height
        <div className="flex flex-col w-full h-[80vh] md:h-[600px] border border-gray-300 rounded-lg">
            <PDFViewer className="flex-1 w-full" style={{ width: '100%', height: '100%' }}>
                {agreementDocument}
            </PDFViewer>
